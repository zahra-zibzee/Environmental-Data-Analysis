...
Now let's turn the images to make them landscape.
...
We tooked the Unet model from [this repo](https://github.com/milesial/Pytorch-UNet/tree/master/unet) and we will use it to train our model.
